...
{
    public class CreateCharacteristicValidator : AbstractValidator<CreateCharacteristicCommand>
    {
        public CreateCharacteristicValidator()
        {
            ...
            RuleFor(x => x.Description)
             .MaximumLength(150).WithMessage("{PropertyName} maksimal length 150");
        }
    }
}
